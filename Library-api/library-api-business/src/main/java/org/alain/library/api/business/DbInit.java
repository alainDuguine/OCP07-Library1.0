//package org.alain.library.api.business;
//
...
//
//    @Autowired
//    public DbInit(UserRepository userRepository, BookRepository bookRepository, BookCopyRepository bookCopyRepository, StatusRepository statusRepository) {
...
//        =======================================================================================*/
//
//        User user1 = new User("alain_duguine@hotmail.fr", "1234", "Alain", "Duguine", "USER","");
//        User user2 = new User("audrey.duguine@gmail.com", "1234","Audrey", "Duguine", "USER","");
